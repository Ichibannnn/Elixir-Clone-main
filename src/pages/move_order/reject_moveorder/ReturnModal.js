...
import { Button, ButtonGroup, Flex, Heading, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Select, Text, useToast, VStack } from '@chakra-ui/react'
...
const ReturnModal = ({ isOpen, onClose, orderNo, fetchRejectedMO }) => {
    ...
    const submitHandler = () => {
        setIsLoading(true)
        try {
            const res = request.put(`Ordering/ReturnMoveOrderForApproval`,
                {
                    orderNo: orderNo,
