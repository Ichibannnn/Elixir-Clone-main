      ...
      <Flex justifyContent='space-between'>
          <InputGroup w='15%'>
              ...
              <Input
                  ...
                  type='text' fontSize="xs" placeholder='Search: ID'
              ...
              <Table size='sm'>
                  <Thead bgColor='secondary'>
                      <Tr>
                          ...
                          <Th color='white' fontSize="11px">Borrowed Date</Th>
                  ...
                  <Tbody>
                      {
                          issueBorrowData?.issue?.map((borrow, i) =>
                              <Tr key={i}>
                                  ...
                                  <Td fontSize="xs">{borrow.borrowedDate}</Td>
                                  <Td fontSize="xs">{borrow.preparedBy}</Td>
                                  <Td fontSize="xs">
                                      <Button
                                          onClick={() => viewHandler(borrow.borrowedPKey, borrow.isActive)}
