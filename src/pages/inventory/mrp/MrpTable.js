            ...
            <Flex justifyContent='space-between' mb={1}>
                <InputGroup w='30%'>
                    ...
                    <Input
                        ...
                        type='text' fontSize="xs" placeholder='Search: Item Description'
                ...
                <Table size='sm'>
                    <Thead bgColor='primary'>
                        <Tr>
                            ...
                            <Th p={0} color='white' fontSize="xs"></Th>
                            <Th color='white' fontSize="xs">Line</Th>
                    ...
                    <Tbody>
                        {
                            mrpData?.inventory?.map((item, i) =>
                                ...
                                >
                                    ...
                                    <Td fontSize="xs">{item.bufferLevel > item.reserve ? <CgDanger color='red' /> : ''}</Td>
                                    ...
                                    <Td fontSize="xs">{item.itemDescription}</Td>
                                    {
                                        !buttonChanger ?
                                            <>
                                                <Td fontSize="xs">{item.subCategory}</Td>
                                                <Td fontSize="xs">{item.uom}</Td>
                                                <Td fontSize="xs">{item.price?.toLocaleString(undefined, { maximumFractionDigits: 2, minimumFractionDigits: 2 })}</Td>
                                                <Td fontSize="xs">{item.totalPrice?.toLocaleString(undefined, { maximumFractionDigits: 2, minimumFractionDigits: 2 })}</Td>
                                                <Td fontSize="xs">{item.soh?.toLocaleString(undefined, { maximumFractionDigits: 2, minimumFractionDigits: 2 })}</Td>
                                                <Td fontSize="xs">{item.reserve?.toLocaleString(undefined, { maximumFractionDigits: 2, minimumFractionDigits: 2 })}</Td>
                                                <Td fontSize="xs">{item.bufferLevel?.toLocaleString(undefined, { maximumFractionDigits: 2, minimumFractionDigits: 2 })}</Td>
                                            </>
                                            :
                                            <>
                                                <Td fontSize="xs">{item.receiveIn?.toLocaleString(undefined, { maximumFractionDigits: 2, minimumFractionDigits: 2 })}</Td>
                                                <Td fontSize="xs">{item.receiptIn?.toLocaleString(undefined, { maximumFractionDigits: 2, minimumFractionDigits: 2 })}</Td>
                                                <Td fontSize="xs">{item.moveOrderOut?.toLocaleString(undefined, { maximumFractionDigits: 2, minimumFractionDigits: 2 })}</Td>
                                                <Td fontSize="xs">{item.issueOut?.toLocaleString(undefined, { maximumFractionDigits: 2, minimumFractionDigits: 2 })}</Td>
                                                <Td fontSize="xs">{item.averageIssuance?.toLocaleString(undefined, { maximumFractionDigits: 2, minimumFractionDigits: 2 })}</Td>
