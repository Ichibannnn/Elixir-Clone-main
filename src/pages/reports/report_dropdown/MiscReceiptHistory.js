...
const fetchMiscellaenouseReceiptApi = async (dateFrom, dateTo) => {
  ...
  const res = await request.get(`Reports/MiscellaneousReceiptReport?dateFrom=${formmattedDateFrom}&dateTo=${formmattedDateTo}`)
  return res.data
}


export const MiscReceiptHistory = ({ dateFrom, dateTo, sample, setSheetData }) => {
