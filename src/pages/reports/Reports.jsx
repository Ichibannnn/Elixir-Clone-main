                    ...
                    <Flex justifyContent='start' flexDirection='column'>
                        ...
                        <HStack>
                            <Select
                                ...
                                placeholder=' ' bgColor='#fff8dc' w='full' fontSize="xs"
                            >
                ...
                <Flex w='full' mt={5} justifyContent='center'>
                    {
                        sample === 1 ?
                            ...
                            :
                            sample === 2 ?
                                <MoveOrderHistory dateFrom={dateFrom} dateTo={dateTo} sample={sample} setSheetData={setSheetData} />
                                :
                                sample === 3 ?
                                    <MiscIssueHistory dateFrom={dateFrom} dateTo={dateTo} sample={sample} setSheetData={setSheetData} />
                                    :
                                    sample === 4 ?
                                        <MiscReceiptHistory dateFrom={dateFrom} dateTo={dateTo} sample={sample} setSheetData={setSheetData} />
                                        :
                                            sample === 5 ?
                                                <CancelledOrders dateFrom={dateFrom} dateTo={dateTo} sample={sample} setSheetData={setSheetData} />
                                                // : sample === 6 ?
