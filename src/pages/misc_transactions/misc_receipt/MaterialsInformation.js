...
import { Box, Button, ButtonGroup, Flex, HStack, Input, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Select, Spinner, Text, useDisclosure, VStack } from '@chakra-ui/react'
...
export const MaterialsInformation = ({ rawMatsInfo, setRawMatsInfo, listDataTempo, setListDataTempo, details, setDetails,
    suppliers, materials, uoms, setSelectorId, setSupplierData, supplierRef, remarks, setRemarks
}) => {
        ...
        <Flex justifyContent='center' flexDirection='column' w='full'>
            <VStack w='full' spacing={6} bg="blackAlpha.100" boxShadow="md">
                <Box bgColor='primary' w="full" pl={2} h="30px" alignItems="center">
                    <Text color='white' textAlign='left' fontWeight='semibold'>Materials Information</Text>
                </Box>
                ...
                <Flex w='full' justifyContent='space-between'>
                    ...
                    <VStack alignItems='start' w='40%' mx={5} >
                        ...
                        {/* Supplier Code */}
                        <HStack w='full'>
                            <Text minW='50%' w='auto' bgColor='primary' color='white' pl={2} py={2.5} fontSize='xs'>Supplier: </Text>
                            {
                                suppliers.length > 0 ?
                                    <Select
                                        fontSize="xs"
                        ...
                        {/* Remarks */}
                        <HStack w='full'>
                            <Text minW='50%' w='auto' bgColor='primary' color='white' pl={2} py={2.5} fontSize='xs'>Transaction Type: </Text>
                               <Select
                                fontSize="xs"
                    ...
                    <VStack alignItems='start' w='40%' mx={5}>
                        ...
                        {/* Supplier Name */}
                        <HStack w='full'>
                            <Text minW='50%' w='auto' bgColor='primary' color='white' pl={2} pr={10} py={2.5} fontSize='xs'>Supplier Name: </Text>
                            <Text fontSize="xs" bgColor='gray.300' w='full' border='1px' borderColor='gray.400' pl={2} py={1.5}>{rawMatsInfo.supplier ? rawMatsInfo.supplier : 'Please select a supplier'}</Text>
                        </HStack>
                ...
                <VStack alignItems='start' w='full'>
                    {/* Details */}
                    <HStack w='full' p={2}>
                        <Text w='auto' bgColor='primary' color='white' pl={2} pr={5} py={2.5} fontSize='xs'>Details: </Text>
                        <Input
                            fontSize="xs"
                ...
                <Flex w='full' justifyContent='end' mt={4} p={2}>
                    <Button
                        ...
                        size='sm' colorScheme='blue' borderRadius="none"
                    >
                        New
                    </Button>
                </Flex>
...
export const RawMatsInfoModal = ({ isOpen, onClose, details, setDetails, rawMatsInfo, setRawMatsInfo,
    listDataTempo, setListDataTempo, supplierRef, materials, uoms, setSelectorId, remarks
}) => {
