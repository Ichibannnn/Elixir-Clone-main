...
export const ListOfIssue = ({ miscData, selectorId, setSelectorId, setTotalQuantity, fetchActiveMiscIssues, fetchBarcodeNo, remarks }) => {
  const TableHead = [
  ...
  return (
    <Flex justifyContent='center' flexDirection='column' w='full'>
        <VStack justifyContent='center' w='full' spacing={-1}>
            ...
            <Text bgColor='secondary' fontSize="xs" w='full' color='white' textAlign='center' fontWeight='semibold' py={1}>List of Receipt</Text>
