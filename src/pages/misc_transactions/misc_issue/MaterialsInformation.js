...
export const MaterialsInformation = ({ rawMatsInfo, setRawMatsInfo, details, setDetails, customerRef,
    customers, rawMats, uoms, barcodeNo, setSelectorId, setCustomerData, setWarehouseId, warehouseId, fetchActiveMiscIssues, customerData, remarks, setRemarks, remarksRef
}) => {
